...
const DEFAULT_SITE_CONFIG = {
  ...
  notifications: [
    { text: '2025 Holiday List', href: 'assets/documents/notices/Gauhati-University-Holiday-LIst-2025.pdf' },
    { text: 'Notice 2025/10/21', href: 'assets/documents/notices/n2025-10-21.jpg' },
    { text: 'Freshers Postponed', href: 'assets/documents/notices/Freshers Posponed.jpg' },
    { text: 'Tribute to Zubeen', href: 'assets/documents/notices/Tribute to zubeen.jpg' }
  ],
  resources: [
  ...
  gallery: [
    { src: 'assets/images/gallery/spic.jpg', alt: 'Campus life image', href: 'assets/images/gallery/spic.jpg' },
    { src: 'assets/images/gallery/mz1.jpg', alt: 'Student activity photo', href: 'assets/images/gallery/mz1.jpg' },
    { src: 'assets/images/gallery/pic.jpg', alt: 'Classroom moment', href: 'assets/images/gallery/pic.jpg' }
  ]
};
